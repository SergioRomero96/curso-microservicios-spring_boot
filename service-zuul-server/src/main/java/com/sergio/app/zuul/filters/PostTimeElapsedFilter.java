...
public class PostTimeElapsedFilter extends ZuulFilter {
	...
	public Object run() throws ZuulException {
		...
		log.info(String.format("Tiempo transcurrido en segundos: %s", elapsed.doubleValue()/1000.00));
		log.info(String.format("Tiempo transcurrido en milesegundos: %s", elapsed));
		return null;
	}
